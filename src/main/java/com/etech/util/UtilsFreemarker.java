...
import com.etech.util.EnumConverter;
...
public final class UtilsFreemarker {
	...
	public static String process(String template, Map<String, ?> model) throws IOException, TemplateException {
		...
		if (applicationContext != null) {
			FreeMarkerConfigurer freeMarkerConfigurer = UtilsSpring.getBean("freeMarkerConfigurer", FreeMarkerConfigurer.class);

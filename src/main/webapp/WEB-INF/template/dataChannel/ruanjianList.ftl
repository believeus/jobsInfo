		...
		<div class="j_main_right">
			<div class="j_main_right_1">
				<p>
					...
					所在位置 > <a href="/dataChannel.jhtml" title="数据频道">数据频道</a>(<span>共${ruanjianList.total}条记录</span>)
				</p>
			</div>
			<div class="j_main_right_2" style="border:1px solid #e4e4e4;">
			<form id="listForm" action="ruanjianList.jhtml">
				<ul>
					[#list ruanjianList.content as ruanjian]
					<li>
				...
				[@pagination pageNumber = ruanjianList.pageNumber totalPages = ruanjianList.totalPages]

		...
		<div class="j_main_left">
			<div class="j_main_left_1" style="background:#F3F3F3;">
				...
				<ul style="padding-left:0;margin:0;">
					<li class="current_li"><a href="/fenxibaogaoList.jhtml">供求分析报告</a></li>
		...
		<div class="j_main_right">
			<div class="j_main_right_1">
				<p>
					...
					所在位置 > <a href="/dataChannel.jhtml" title="数据频道">数据频道</a>(<span>共${analysisreport.total}条记录</span>)
				</p>
			</div>
			<div class="j_main_right_2" style="border:1px solid #e4e4e4;">
			<form id="listForm" action="fenxibaogaoList.jhtml">
				<ul>
					[#list analysisreport.content as analysisreport]
					<li>
						<a href="/report.jhtml?id=${analysisreport.id}" title="${analysisreport.title}">
							[#if analysisreport.title?length > 30 ]
								${analysisreport.title?string?substring(0,30)}...
							[#else]
				...
				[@pagination pageNumber = analysisreport.pageNumber totalPages = analysisreport.totalPages]

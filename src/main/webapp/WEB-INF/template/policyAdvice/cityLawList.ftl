...
<body>
	...
	<div class="j_main w">
		<div class="j_main_left">
			<div class="j_main_left_1" style="background:#F3F3F3;">
				...
				<ul style="padding-left:0;margin:0;">
					...
					<li style=""><a href="/cityFileList.jhtml">地方相关文件</a></li>
				</ul>
			</div>
		...
		<div class="j_main_right">
			...
			<form id="listForm" action="cityLawList.jhtml">
				<ul>
				[#list dataCenterList.content as dataCenter]
					<li>
						<a href="/cityLaw.jhtml?id=${dataCenter.id}">${dataCenter.title}</a><span>${dataCenter.editTime?number_to_datetime}</span>
					</li>
				[/#list]	
				</ul>

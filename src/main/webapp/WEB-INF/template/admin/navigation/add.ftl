...
<title>${message("admin.navigation.add")} - Powered By e3dmall</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" id="name" name="name" class="text" maxlength="200" />	 <label><font color="blue">(如:首页、店铺、品牌等)</font></label>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select id="systemUrl">
						<option value="${base}/">网站${message("admin.navigation.home")}</option>
			...
			<tr>
				...
				<td>
					<input type="text" id="url" name="url" class="text" maxlength="200" /><label><font color="blue">(如:/、/shops/shops.jhtml、/brands/brands.jhtml等)</font></label>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select name="position">
						[#list positions as position]
							<option value="middle"[#if position == "middle"] selected="selected"[/#if]>${message("Navigation.Position."+position)}导航栏</option>
						[/#list]
					</select>
				</td>
			</tr>

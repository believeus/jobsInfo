...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 买家管理 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="/admin/member/list.jhtml" method="get">
		<div class="bar">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="mobile">${message("Member.email")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="email">手机号</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="loginIp">最后登录IP</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="loginCount">登录次数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="distributorCount_a">一级分销商数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="distributorCount_b">二级分销商数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="distributorCount_c">三级分销商数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="totalBrokerage">佣金总额</a>
				</th>
				<th>
			...
			[#list page.content as member]
				<tr>
					...
					<td>
						${member.distributorCount_b}
					</td>
					<td>
						${member.distributorCount_c}
					</td>
					<td>

...
<title>视频新闻列表 - Powered By e3dmall</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			...
			<tr>
				...
				<td>
					[#if center.top == 1]
						<a href="/admin/vedioNews/unVedioNewsTop.jhtml?id=${center.id}"><font color="green">取消置顶</font></a>
					[#else]
						<a href="/admin/vedioNews/vedioNewsTop.jhtml?id=${center.id}"><font color="red">点击置顶</font></a>
					[/#if]
				</td>
				<!--<td>

...
<title>${message("admin.role.edit")} - Powered By e3dmall</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">资产管理</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:asset"[#if role.authorities?seq_contains("admin:asset")] checked="checked"[/#if] />资产管理
						</label>
					</span>
				</td>
			</tr>

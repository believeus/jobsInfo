...
<title>${message("admin.specification.list")} - Powered By e3dmall</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="productCategories">${message("Specification.productCategory")}</a>
				</th>
				<th>
			...
			[#list page.content as specification]
				<tr>
					...
					<td>
						[#list specification.productCategories as  pCategories]
						${pCategories.name}、

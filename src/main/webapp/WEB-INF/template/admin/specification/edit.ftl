...
<title>${message("admin.specification.edit")} - Powered By e3dmall</title>
...
$().ready(function() {
		...
		if ($type.val() == "text") {
			[@compress single_line = true]
				...
				'<tr class="specificationValueTr">
					...
					<\/td>
					<td>
						<input type="text" name="specificationValuesOrder" class="text specificationValuesOrder" maxlength="9" value="1" style="width: 30px;" \/>
					<\/td>
					<td>
	...
	$deleteSpecificationValue.live("click", function() {
		...
		$("input[name=deleteSpecificationValues]").val(array.toString());
	});
	...
	$("#inputForm").submit(function(){
		$("input[name=specificationValuesOrder]").each(function(){
			var $this = $(this);
			if($.trim($this.val()) == ""){
				$this.val(1);
			}		
...
function addName(obj){
	...
	tr.find(".specificationValuesName").attr("name","updateNames");
	tr.find(".specificationValuesImage").attr("name","updateImages");
	tr.find(".specificationValuesOrder").attr("name","updateOrders");
}
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<input type="hidden" name="deleteSpecificationValues" value="" />
		<table id="specificationTable" class="input">
		   <tr>
			...
			[#list specification.specificationValues as specificationValue]
				<tr class="specificationValueTr">
					<td>
						<input type="hidden" value="${specificationValue.id}" />
					</td>
					<td>
						<input type="text" class="text specificationValuesName" onchange="addName(this)"  value="${specificationValue.name}" maxlength="200" />
					</td>
					<td>
						[#if specification.type == "text"]
							<span class="fieldSet">
								<input type="text"  class="text specificationValuesImage" onchange="addName(this)" value="${specificationValue.image}" maxlength="200" disabled="disabled" />
								<input type="button" class="button browserButton" value="${message("admin.browser.select")}" disabled="disabled" />
							</span>
						[#else]
							<span class="fieldSet">
								<input type="text" class="text specificationValuesImage" onchange="addName(this)" value="${specificationValue.image}" maxlength="200" />
								<input type="button" class="button browserButton" value="${message("admin.browser.select")}" />
					...
					<td>
						<input type="text" class="text specificationValuesOrder" onchange="addName(this)" value="${specificationValue.order}" maxlength="9" style="width: 30px;" />
					</td>
					<td>

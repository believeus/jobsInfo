...
<title>添加工作动态 - Powered By e3dmall</title>
...
<body>
	...
	<form id="inputForm" action="/admin/work/save.jhtml" method="post" enctype="multipart/form-data">
		<input type="hidden" name="type" value="${type}"/>
		<table class="input">
			<tr>
				<th>
					<span class="requiredField">*</span>动态标题:
				</th>
				<td>

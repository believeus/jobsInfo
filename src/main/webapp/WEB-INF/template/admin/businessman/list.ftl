...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 供应商管理 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="username">供应商</a>
				</th>
				...
				<th>
					<a href="javascript:;" class="sort" name="email">VIP</a>
				</th>
				<th>
			...
			[#list page.content as businessman]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${businessman.id}"/>
					</td>
					<td>
					...
					<td>
						<span title="${businessman.createDate?string("yyyy-MM-dd HH:mm:ss")}">${businessman.createDate}</span>
					</td>
					<td>
					...
					<td>
						<a href="view.jhtml?id=${businessman.id}">[${message("admin.common.view")}]</a>
						<a href="edit.jhtml?id=${businessman.id}">[审核]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<title>${message("admin.index.title")} - Powered By e3dmall</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.e3dmall.com" target="_blank">http://www.e3dmall.com</a>
			</td>
			<th>
		...
		<tr>
			<td class="powered" colspan="4">
				COPYRIGHT © 2010-2014 e3dmall.com ALL RIGHTS RESERVED.
			</td>
		</tr>
	</table>
</body>

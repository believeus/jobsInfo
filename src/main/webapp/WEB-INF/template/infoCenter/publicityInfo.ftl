	...
	<div class="j_main w">
		...
		<div class="j_main_right">
			...
			<div class="j_main_right_2" style="border:1px solid #e4e4e4;">
				...
				<p class="j_main_right_2_p" style="text-align:center;">来源：[#if data.title?exists]${data.author}[#else]潜江公共就业服务网[/#if] 发布时间：${data.editTime?number_to_datetime}&nbsp;${data.editTime?number_to_time} 浏览次数： 147次</p>
